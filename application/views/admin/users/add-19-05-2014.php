				...
				<div class="widget-content nopadding">
					<form class="form-horizontal form-inline" method="post" action="<?php echo current_url(); ?>" name="basic_validate" id="main-form">
						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-3">
									...
									<div class="controls">
										<input type="text" name="rotarian_price" id="rotarian_price" >
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" name="spouse_price" id="spouse_price" >
									</div>
								</div>
							</div>
							</div>
						...
						<div class="form-group" id="group_div" style="display:none">
							<div class="row">
								...
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount" name="rot_single_amount" >
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount" name="rot_cupple_amount" >
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount" name="non_rot_single_amount" >
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount" name="non_rot_cupple_amount" >
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount" name="patron_single_amount" >
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
		  								<input type="text" class="txt_amount" name="patron_cupple_amount" >
									</div>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="controls">
								<input type="text" name="total_price" id="total_price" >&nbsp;&nbsp;<span id='discountext' style="font-size:13px;color:green;display:none;">You get a flat 1000/- discount per person</span>
							</div>
						</div>
						<div class="form-group">
