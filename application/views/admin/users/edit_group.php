				...
				<div class="widget-content nopadding">
					<form class="form-horizontal" method="post" action="<?php echo current_url(); ?>" name="basic_validate" id="main-form">
	  					...
	  					<div id="rotary_div" <?php if($user['rot_category'] == "rotract" || $user['rot_category'] == "non-rotarian") echo 'style="display:none;"';?> >
							<div class="form-group">
								...
								<div class="controls">
									...
									<span <?php if($user['rot_category'] != "other-district") echo "style='display:none;width:auto;'";?> id="rot_club_text"><input type="text" name="rotary_club_of_other" style="width:250px;" class="required"></span>
								</div>
							</div>
							<div class="form-group">
						...
						<div class="form-group" id="club_name" <?php if($user['rot_category'] != "non-rotarian") echo 'style="display:none;"';?>>
							...
							<div class="controls">
								<input type="text" name="nonrot_club" class="required" value="<?=$user['nonrot_club']?>">
							</div>
						</div>
						...
						<div class="form-group" id="group_div" style="display:block">
							<div class="row">
								<div class="col-3">
									...
									<div class="controls">
										<input type="text" name="rot_single" class="txt_member number" value="<?php echo $user['rot_single'];?>" data-price="<?php echo $rot_price['individual'];?>">
									</div>
								</div>
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount number" name="rot_single_amount" value="<?php echo $user['rot_single_amount'];?>" >
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-3">
									...
									<div class="controls">
										<input type="text" name="rot_cupple" class="txt_member couple number" value="<?php echo $user['rot_cupple'];?>" data-price="<?php echo $rot_price['individual']+$rot_price['spouse'];?>">
									</div>
								</div>
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount number" name="rot_cupple_amount" value="<?php echo $user['rot_cupple_amount'];?>" >
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-3">
									...
									<div class="controls">
										<input type="text" name="non_rot_single" class="txt_member number" value="<?php echo $user['non_rot_single'];?>" data-price="<?php echo $non_rot_price['individual'];?>">
									</div>
								</div>
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount number" name="non_rot_single_amount" value="<?php echo $user['non_rot_single_amount'];?>" >
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-3">
									...
									<div class="controls">
										<input type="text" name="non_rot_cupple" class="txt_member couple number" value="<?php echo $user['non_rot_cupple'];?>" data-price="<?php echo $non_rot_price['individual']+$non_rot_price['individual'];?>">
									</div>
								</div>
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount number" name="non_rot_cupple_amount" value="<?php echo $user['non_rot_cupple_amount'];?>" >
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-3">
									...
									<div class="controls">
										<input type="text" name="patron_single" class="txt_member number" value="<?php echo $user['patron_single'];?>" data-price="<?php echo $patron_price['individual'];?>">
									</div>
								</div>
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount number" name="patron_single_amount" value="<?php echo $user['patron_single_amount'];?>" >
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-3">
									...
									<div class="controls">
		  								<input type="text" name="patron_cupple" class="txt_member couple number" value="<?php echo $user['patron_cupple'];?>" data-price="<?php echo $patron_price['couple'];?>">
									</div>
								</div>
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
		  								<input type="text" class="txt_amount number" name="patron_cupple_amount" value="<?php echo $user['patron_cupple_amount'];?>" >
									</div>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="controls">
								<input type="text" name="total_price" class="number" id="total_price" value="<?php echo $user['total_price'];?>" >&nbsp;&nbsp;<span id='discountext' style="font-size:13px;color:green;display:none;">You get a flat 1000/- discount per person</span>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group <?php if($user['mode_of_payment'] !="cheque") echo 'hide_div';?>" id="cheque">
							...
							<div class="controls">
								<input type="text" name="cheque_number" class="number required" value="<?php echo $user['cheque_number'];?>" maxlength="6" minlength="6">
							</div>
