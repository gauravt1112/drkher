						...
						<div class="form-group" id="group_div" style="display:block">
							<div class="row">
								...
								<div class="col-3">
									...
									<div class="controls">
										<input type="text" class="txt_amount" name="rot_single_amount" value="<?php echo $user['rot_single_amount'];?>" >
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount" name="rot_cupple_amount" value="<?php echo $user['rot_cupple_amount'];?>" >
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount" name="non_rot_single_amount" value="<?php echo $user['non_rot_single_amount'];?>" >
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount" name="non_rot_cupple_amount" value="<?php echo $user['non_rot_cupple_amount'];?>" >
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
										<input type="text" class="txt_amount" name="patron_single_amount" value="<?php echo $user['patron_single_amount'];?>" >
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-3">
									<label class="control-label">Amount</label>
									<div class="controls">
		  								<input type="text" class="txt_amount" name="patron_cupple_amount" value="<?php echo $user['patron_cupple_amount'];?>" >
									</div>
								</div>
							</div>
						</div>
