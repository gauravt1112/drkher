...
header('Content-Disposition: attachment; filename=groups-'.date('d-m-Y').'.xls');
?>
...
<thead>
	<tr>
		...
		<th>Badge Name</th>
		<th>Gender</th>
		<th>Rotarian Single</th>
		<th>Amount</th>
		<th>Rotarian Couple</th>
		<th>Amount</th>
		<th>Non Rotarian Single</th>
		<th>Amount</th>
		<th>Non Rotarian Couple</th>
		<th>Amount</th>
		<th>Patron Single</th>
		<th>Amount</th>
		<th>Patron Couple</th>
...
<tbody>
	...
	<tr>
		...
		<td><?php echo $users[$i]['rot_single']?></td>
		<td><?php echo $users[$i]['rot_single_amount']?></td>
		<td><?php echo $users[$i]['rot_cupple']?></td>
		<td><?php echo $users[$i]['rot_cupple_amount']?></td>
		<td><?php echo $users[$i]['non_rot_single']?></td>
		<td><?php echo $users[$i]['non_rot_single_amount']?></td>
		<td><?php echo $users[$i]['non_rot_cupple']?></td>
		<td><?php echo $users[$i]['non_rot_cupple_amount']?></td>
		<td><?php echo $users[$i]['patron_single']?></td>
		<td><?php echo $users[$i]['patron_single_amount']?></td>
		<td><?php echo $users[$i]['patron_cupple']?></td>
		<td><?php echo $users[$i]['patron_cupple_amount']?></td>
