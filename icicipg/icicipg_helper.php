...
if(isset($_SESSION['pay_session']) && $_SESSION['pay_session'] == true) {
	...
	$oBTA->setAddressDetails ($_SESSION['cust_id'],$_SESSION['cust_name'],$_SESSION['addr1'],$_SESSION['addr2'],$_SESSION['addr3'],$_SESSION['city'],$_SESSION['state'],$_SESSION['pincode'],"IND",$_SESSION['email']);
	// $oBTA->setAddressDetails ("CID","Tester","Aline1","Aline2","Aline3","Pune","A.P","48927489","IND","tester@soft.com");

	$oSTA->setAddressDetails ($_SESSION['addr1'],$_SESSION['addr2'],$_SESSION['addr3'],$_SESSION['city'],$_SESSION['state'],$_SESSION['pincode'],"IND",$_SESSION['email']);
