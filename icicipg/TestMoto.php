...
$oMerchant->setMerchantDetails($key,$key,$key,"10.10.10.238",rand()."","OrderRef1","http://discon2015.org/icicipg/SFAResponse.php","","INR","INV1234","req.Sale","100","","Ext1","Ext2","Ext3","Ext4","Ext5");
